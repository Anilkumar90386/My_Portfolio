  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-600 p-5 md:p-10 md:w-[450px] "
            style={{
            ...
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  ...
                  <span className=" text-sm leading-[1.6] text-gray4  mt-2 font-bold">
                    {item.name}
                  </span>
